...
# `& { ... }`: the advertised invocation is `irm | iex`, which runs this text in the
# person's own session. At top level the strict mode, the preferences and the Say/Die
# functions below would all outlive the install and quietly change how their shell
# behaves afterwards. A script block keeps them to this run.
& {
