...
class Session:
    ...
    # A Scope (sellee.store.Scope) binds a headless pass to the entities it was spawned for;
...
class ToolContext:
    ...
    session: Session
    store: object  # sellee.store.Store
    bus: object  # sellee.events.EventBus
    config: object  # sellee.config.Config
    ...
    # The marketplace reply sink, as a factory like everything else acquired lazily: calling it
