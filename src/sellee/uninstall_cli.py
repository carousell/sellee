"""`sellee uninstall` — take it all back off, and say exactly what went.
...
from sellee import deployment, paths, supervisor
...
def _run(args, ui: Ui) -> int:
    ...
    ui.step("Uninstalling sellee from this computer")
