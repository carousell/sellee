...
# The mixins Store is composed from. Imported here rather than at the top of the file
# because each one imports helpers back out of this module by name, which resolves only
# once everything above is defined — so a new shared name goes above this block. E402 is
# waived per-line rather than per-file, so an import that lands up top is still checked.
#
# Those imports bind by value at import time, so patching a helper on this module does not
# reach a mixin's callers. Tests go through tests/conftest.py's patch_store_attr instead.
from sellee.store.channel import ChannelMixin  # noqa: E402
from sellee.store.escalations import EscalationsMixin  # noqa: E402
from sellee.store.items import ItemsMixin  # noqa: E402
from sellee.store.negotiation import NegotiationMixin  # noqa: E402
from sellee.store.passes import PassesMixin  # noqa: E402
from sellee.store.scam import ScamMixin  # noqa: E402
from sellee.store.send import SendMixin  # noqa: E402
from sellee.store.settings import SettingsMixin  # noqa: E402
from sellee.store.threads import ThreadsMixin  # noqa: E402
from sellee.store.wants import WantsMixin  # noqa: E402
